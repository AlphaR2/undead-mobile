...
// import { generateBattleQuiz } from "@/components/BattleArena/ConceptGenerator";
...
//       return (
//         <div className="bg-blue-500/20 border border-blue-500/50 rounded-xl p-4 relative overflow-hidden">
//           {/* Animated background */}
//           <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 via-blue-400/10 to-blue-500/5 animate-pulse"></div>
...
//               <p className="text-blue-200 text-sm">{loadingProgress}</p>
...
//                   <span>Subsequent attempts are usually faster</span>
//                 </div>
//               )}
//             </div>
//           </div>
...
//     if (conceptsLoaded) {
//       return (
//         <div className="bg-green-500/20 border border-green-500/50 rounded-xl p-4 relative overflow-hidden">
//           <div className="absolute inset-0 bg-gradient-to-r from-green-500/5 via-green-400/10 to-green-500/5"></div>
//           <div className="relative">
...
//     if (conceptsError) {
//       return (
//         <div className="bg-red-500/20 border border-red-500/50 rounded-xl p-4 relative">
//           <div className="flex items-center gap-2 mb-2">
...
//             )}
//           </div>
//           <p className="text-red-200 text-sm mb-3">{conceptsError}</p>
//           <div className="space-y-2">
//             <button
...
//                       <li>• Server might be experiencing issues</li>
...
//     // Default state - show load button
//     return (
//       <div className="bg-blue-500/20 border border-blue-500/50 rounded-xl p-4 relative overflow-hidden">
...
//             <span>Load Battle Concepts</span>
//           </button>
//           <div className="flex items-center gap-2 text-xs text-blue-300 mt-2">
//             <Wifi className="w-3 h-3" />
//             <span>First load may take 30+ seconds if server is sleeping</span>
//           </div>
//         </div>
//       </div>
//     );
...
//                     <TouchableOpacity
//                       onPress={() => {
//                         setSelectedWarrior(safeWarrior as unknown as Warrior);
...
//                   <Text className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#cd7f32] to-[#ff8c42] bg-clip-text text-transparent flex flex-row items-center gap-3">
